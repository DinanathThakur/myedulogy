            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form role="form" name="course_search" method="get" action="coursesearch.html" class="home-search">
                        ...
                        <p class="movecenter" style="font-size:17px; margin-top:1px;">
                            <a href="Pmp.html" style="color:#FFF;" target="_blank">PMP<sup>®</sup> | </a>
                            <a href="ITIL.html" style="color:#FFF;">ITIL<sup>®</sup> | </a>
                            <a href="Agile.html" style="color:#FFF;" target="_blank">Agile & Scrum<sup>®</sup> |</a> 
                            <a href="Devops.html" style="color:#FFF;" target="_blank">DEVOPS<sup>®</sup> |</a>
                            <a href="TOGAF.html" style="color:#FFF;" target="_blank">TOGAF<sup>®</sup> | </a> 
                            <a href="SixSigma.html" style="color:#FFF;" >Six Sigma | </a>
                            <a href="PMP-ACP.html"  style="color:#FFF;">PMI-ACP<sup>®</sup>  </a>
                            <br/> <br/>
                        </p>
                        <div class="col-sm-12 free-trial-btn"> <a href="#" class="el-btn-regular">Start My Free Trial</a> </div>
                    </form>
...
<section class="events events-style02">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="col-sm-2"> <img alt="owlcarousel-item-img" src="/assets/images/clients/Logo-01.png"/> </div>
                <div class="col-sm-2"> <img alt="owlcarousel-item-img" src="/assets/images/clients/Logo-02.png"/> </div>
                <div class="col-sm-2"> <img alt="owlcarousel-item-img" src="/assets/images/clients/Logo-03.png"/> </div>
                <div class="col-sm-2"> <img alt="owlcarousel-item-img" src="/assets/images/clients/Logo-04.png"/> </div>
                <div class="col-sm-2"> <img alt="owlcarousel-item-img" src="/assets/images/clients/Logo-05.png"/> </div>
                <div class="col-sm-2"> <img alt="owlcarousel-item-img" src="/assets/images/clients/Logo-06.png"/> </div>
            ...
            <div class="contact-one-form">
                <form id="ajax-contact" method="post" action="#">
                    <div class="form-group row">
                        <div class="col-sm-6"> <input type="text" placeholder="Name *" required> </div>
                        <div class="col-sm-6"> <input type="email" placeholder="Email *" required> </div>
                        <div class="col-sm-6"> <input type="text" placeholder="Subject *" required> </div>
                        <div class="col-sm-6"> <input type="text" placeholder="Phone *" required> </div>
                        <div class="col-sm-12"> <textarea placeholder="Message" required></textarea> </div>
                        <div class="col-sm-12"> <button type="submit">Send Message</button> </div>
                    </div>
