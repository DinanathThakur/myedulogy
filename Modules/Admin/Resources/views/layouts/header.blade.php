<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="/admin" class="site_title"><i class="fa fa-paw"></i> <span>Edulogy</span></a>
        </div>
...
<!--                     <li><a><i class="fa fa-edit"></i> Course <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="form.html">Add new Course Form</a></li>
                            <li><a href="form_advanced.html">Manage Courses</a></li>
                        </ul>
                    </li>
 -->
                </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <!-- <img src="/admin-assets/images/img.jpg" alt=""> -->
                        Admin
